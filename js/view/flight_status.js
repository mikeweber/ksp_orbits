...
(function(namespace, helpers, $) {
  ...
  namespace.FlightStatus = (function() {
    ...
    klass.prototype.updateStatus = function(t, ship) {
      ...
      this.updateStat('kerbin_distance', helpers.calcObjectDistance(ship, this.sim.getBody('Kerbin')).dividedBy(1000).round() + 'km')
      this.updateStat('duna_distance', helpers.calcObjectDistance(ship, this.sim.getBody('Duna')).dividedBy(1000).round() + 'km')
