...
(function(namespace, helpers, makeObservable) {
  ...
  namespace.FlightLog = (function() {
    ...
    function shipTelemetry(ship, t) {
      return '(' + ship.getParent().name + ', ' + ship.getRadius() + ', ' + ship.getVelocity() + ', { r: ' + ship.getDistanceFromParent(t) + ', phi: ' + ship.getArgumentOfPeriapsis(t).plus(ship.getTrueAnomaly(t)) + ' }, ' + ship.getCartesianAngle(t) + ', ' + ship.getCartesianPrograde(t) + ', ' + ship.getHeading(t) + ', ' + ship.isHeadingAbsolute() + ')'
    }
